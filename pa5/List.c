...
// frees its memory to delete the list
void freeList (List* pL){
    if ((*pL) == NULL) {
        printf("List.c: Passing Nullpointer to freeList()");
        return;
    }
...
int length(List L){
    if (L == NULL){
        printf("List.c: Passing Nullptr to length()");
        return -1;
    }
    return L->length;
}
...
int getIndex(List L){
    if (L == NULL){
        printf("List.c: Passing Nullptr to getIndex()");
        return -1;
    }
    return L->index;
}
...
int front(List L){
    if (L == NULL){
        printf("List.c: Passing Nullptr to front()");
        return -1;
    }
...
int back(List L){
    if (L == NULL){
        printf("List.c: Passing Nullptr to back()");
        return -1;
    }
...
int getElement(List L){
    if (L == NULL){
        printf("List.c: Passing Nullptr to getElement()");
        return -1;
    }
...
// if the two lists are the same return true
int equals (List A, List B){
    if (A == NULL || B == NULL){
        printf("List.c: Passing Null ptrs to equals()");
        return -1;
    }
    node right = A->front;
    node left = B->front;
...
void clear(List L){
    if (L == NULL){
        printf("List.c: Passing null ptr to clear()");
        return;
    }
    node front = L->front;
    while (front != NULL){
...
void moveTo(List L, int i){
    if (L == NULL){
        printf("List.c: Passing null ptr to moveTo()");
        return;
    }
...
void movePrev(List L){
    if (L == NULL) {
        printf("List.c: passing null ptr to movePrev");
        return;
    }
...
void moveNext(List L){
    if (L == NULL) {
        printf("List.c: passing null ptr to moveNext");
        return;
    }
...
void prepend(List L, int data){
    if(L == NULL) {
        printf("List.c: passing null ptr to prepend()");
        return;
    }
    L->length++;
    // creates a new node
...
void append(List L, int data){
    if(L == NULL){
        printf("List.c: passing null ptr to append()");
        return;
    }
    // creates a new node
    L->length++;
...
void insertBefore(List L, int data){
    if (L == NULL){
        printf("List.c: passing null ptr to insertBefore()");
        return;
    }
...
void insertAfter(List L, int data){
    if(L == NULL){
        printf("List.c: passing null ptr to insertAfter()");
        return;
    }
...
void deleteFront(List L){
    if(L == NULL){
        printf("List.c: passing null ptr to deleteFront()");
        return;
    }
...
void delete(List L){
    if(L == NULL){
        printf("List.c: passing null ptr to delete()");
        return;
    }
...
void printList (FILE *out, List L){
    if (L == NULL){
        printf("List.c: passing null List ptr to printList()");
        return;
    }
    if (out == NULL){
        printf("List.c: passing null FILE ptr to printList()");
        return;
    }
...
List copyList(List L){
    if(L == NULL){
        printf("List.c: passing null ptr to copy()");
        return NULL;
    }
    List copy = newList();
...
// Returns a new List which is the concatenation
