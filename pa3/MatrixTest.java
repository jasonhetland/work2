...
// My Testing for other functions
//    D = A.add(A);
//    System.out.println("D = A + A has " + C.getNNZ() + " non-zero entries:");
//    System.println(D);

//    C = A.scalarMult(1.5);
//    System.println("C = (1.5)*A has + C.getNNZ + " non-zero entries:");
//    System.println(C);
...
//    H = A.copy();
//    System.out.println("H = copy(A) has " + H.getNNZ() + " none-zero entires:");
//    System.outprintln(H);
//    System.out.println("Is A equal to H" + A.equals(H));
   
//    F = B.transpose();
//    System.out.println("F = trans(A) " + F.getNNZ() + "non-zero entries:");
//    System.out.println(F);  
